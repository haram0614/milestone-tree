...
layers.m.milestones[15-1].effectDescription=layers.m.milestones[21-1].effectDescription=function(){
	if(player.um.best.gte(parseInt(this.id)+1))return "解锁2个新的声望升级，并且声望升级13和14的效果变得更好。（已升级）";
	return "解锁2个新的声望升级。";
}
